  ...
  helpers = {
    transition: function(attrs, content) {
      ...
      if (attrs.duration != null) {
        this.selection.duration(attrs.duration);
    ...
    call: function(content) {
      var selection;
      selection = this.selection = this.selection.call(content);
      return selection;
    },
    textValue: function(content) {
      var selection;
      selection = this.selection = this.selection.text(content);
      return selection;
    }
  };
