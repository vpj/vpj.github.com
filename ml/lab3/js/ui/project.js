define(["require", "exports", "./api", "./app", "./source_view", "./source_code", "./notes", "./files"], function (require, exports, api_1, app_1, source_view_1, source_code_1, notes_1, files_1) {
    ...
    var Project = /** @class */ (function () {
        function Project() {
            ...
            app_1.ROUTER.route('c/:search', [function (search) {
                    search = decodeURIComponent(search);
                    _this.sourceView.search(search);
                }]);
        ...
        Project.prototype.searchCode = function (search) {
            app_1.ROUTER.navigate("c/" + encodeURIComponent(search), { trigger: false });
